...
class ReviewByUserSubjectIdResource(Resource):
    """
    Class for handling the GET "user/<int:id>/review?query"

    GET is used to get the reviews for a User model, given a User id and Subject id
