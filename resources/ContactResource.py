...
class ContactResource(Resource):
    ...
    def post(self, offer_id):
        ...
        message = "Beste {},<br><br>{} heeft gereageerd op uw {} bijles aanbieding met het volgende bericht:<br><br>\"{}\"<br><br>U kunt contact opnemen met de afzender door te antwoorden op deze email, of door rechtstreeks een email naar {} te sturen.<br><br>Met vriendelijke groet,<br>Het Vlakbijles team".format(user_recipient.meta.name, user_sender.meta.name, offer.subject.name, offer_contact_data["message"], user_sender.email)
