...
from resources.ReviewResource import ReviewByUserIdResource, ReviewResource, EndorsmentByUserIdResource
...
api.add_resource(EndorsmentByUserIdResource, '/user/<int:id>/endorsment')
